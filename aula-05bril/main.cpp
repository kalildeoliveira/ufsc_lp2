...
vector<pair<char, char> > CriarTabela2(int desloc);
...
int main()
{
    ...
    cout << "Texto Encriptado: " << TextEncriptado << endl << endl;
     ...
     vector<pair<char, char> > TabelaConversao2;
     TabelaConversao2 = CriarTabela2(15);

    // DESCRIPTAR
    string TextDecriptado = Decriptar(TextEncriptado, TabelaConversao2);
